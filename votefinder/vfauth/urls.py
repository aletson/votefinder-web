...
urlpatterns = [
    url(r'^link_profile/*$', auth_views.give_user_profile_key),
    url(r'^link_profile/2/*$', auth_views.link_profile),
    url(r'^link_profile/done/*$', auth_views.link_user_to_profile),
    url(r'^create/*$', auth_views.create_votefinder_account),
